...
## 4. Proposed Solution
- Users can land on a standalone page (e.g. `yourgi.com/book/best-care-guarantee`), separate from the homepage, and state the service they want without picking a provider.
